...
public class Objective4Lab1 {
  public static void main(String[] args) {
    ...
    String favoriteAnimal = "favorite animal?";
    String favoriteFood = "favorite food?";
    String favoriteSong = "favorite song?";
    String question = "What is your ";

    //TODO prompt the user to get input for all of the String variables.
    System.out.println(question + fname);
    fname = keyboard.nextLine();
    System.out.println(question + lname);
    lname = keyboard.nextLine();
    System.out.println(question + favoriteAnimal);
    favoriteAnimal = keyboard.nextLine();
    System.out.println(question + favoriteFood);
    favoriteFood = keyboard.nextLine();
    System.out.println(question + favoriteSong);
